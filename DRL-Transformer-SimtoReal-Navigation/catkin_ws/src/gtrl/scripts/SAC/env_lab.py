...
class GazeboEnv:
    ...
    def __init__(self, launchfile, ROS_MASTER_URI, height, width, nchannels):
        ...
        if launchfile.startswith("/"):
            ...
            fullpath = os.path.join('/home/seher/Project/src/DRL-Transformer-SimtoReal-Navigation/catkin_ws/src/gtrl/launch', launchfile)
        ...
        self.image_fish = rospy.Subscriber('/pcOnImage_image', Image, self.image_fish_callback, queue_size=1)#/pcOnImage_image
    ...
    def step(self, act, timestep):
        ...
        while data_obs_fish is None:
            try:
                data_obs_fish = rospy.wait_for_message('/pcOnImage_image', Image, timeout=0.1)#/pcOnImage_image
            except:
                pass
